...
ChannelURL := "discord://discord.com/channels/980717817240358912/1429858706018799616" ; Wicked Steamers server, #working channel
Message := "/work"
...
UpdateTrayIcon() {
    ...
    if (ScriptRunning) {
        A_IconTip := "Wicked6 Auto-Poster (ACTIVE)"
        TraySetIcon("Shell32.dll", 166)
    } else {
        A_IconTip := "Wicked6 Auto-Poster (Inactive)"
        TraySetIcon("Shell32.dll", 168)
    }
}
